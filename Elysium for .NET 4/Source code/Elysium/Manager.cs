...
namespace Elysium
{
    ...
    public static class Manager
    {
        ...
        private static readonly Collection<WeakReference> Cache = new Collection<WeakReference>();
        ...
        internal static void Apply(this FrameworkElement control, Theme? theme, SolidColorBrush accentBrush, SolidColorBrush contrastBrush)
        {
            ...
            control.Dispatcher.Invoke(new ApplyThemeToControlDelegate(ApplyInternal), DispatcherPriority.Render, control, theme, accentBrush, contrastBrush);
        }
        ...
        private delegate void RemoveThemeFromControlDelegate(FrameworkElement control);
        ...
        internal static void Remove(this FrameworkElement control)
        {
            ...
            control.Dispatcher.Invoke(new RemoveThemeFromControlDelegate(RemoveInternal), DispatcherPriority.Render, control);
        }
        ...
        [SecurityCritical]
        private static void ApplyCore(ResourceDictionary resources, Theme? theme, SolidColorBrush accentBrush, SolidColorBrush contrastBrush)
        {
        ...
        [SecurityCritical]
        private static void RemoveCore(ResourceDictionary resources)
        {
            ValidationHelper.NotNull(resources, "resources");
