...
copy "..\Binary\Release\x86\SDK\MSI\Setup.exe" "..\Deploy\SDK\Setup (x86).exe"
del "..\Deploy\SDK\Installer (en-us, x86).msi"
copy "..\Binary\Release\x86\SDK\MSI\en-us\Installer.msi" "..\Deploy\SDK\Installer (en-us, x86).msi"
del "..\Deploy\SDK\Installer (ru-ru, x86).msi"
copy "..\Binary\Release\x86\SDK\MSI\ru-ru\Installer.msi" "..\Deploy\SDK\Installer (ru-ru, x86).msi"
del "..\Deploy\SDK\Setup (x64).exe"
copy "..\Binary\Release\x64\SDK\MSI\Setup.exe" "..\Deploy\SDK\Setup (x64).exe"
del "..\Deploy\SDK\Installer (en-us, x64).msi"
copy "..\Binary\Release\x64\SDK\MSI\en-us\Installer.msi" "..\Deploy\SDK\Installer (en-us, x64).msi"
del "..\Deploy\SDK\Installer (ru-ru, x64).msi"
copy "..\Binary\Release\x64\SDK\MSI\ru-ru\Installer.msi" "..\Deploy\SDK\Installer (ru-ru, x64).msi"
del "..\Deploy\Runtime\Installer (x86).msi"
copy "..\Binary\Release\x86\Runtime\MSI\Installer.msi" "..\Deploy\Runtime\Installer (x86).msi"
del "..\Deploy\Runtime\Installer (x64).msi"
copy "..\Binary\Release\x64\Runtime\MSI\Installer.msi" "..\Deploy\Runtime\Installer (x64).msi"
