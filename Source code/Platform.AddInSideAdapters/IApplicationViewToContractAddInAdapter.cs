...
{
    [AddInAdapter]
    public class IApplicationViewToContractAddInAdapter : ContractBase, Contracts.IApplication
    {
        private readonly IApplication _view;

        public IApplicationViewToContractAddInAdapter(IApplication view)
        {
            _view = view;
        }
        ...
        internal IApplication GetSource()
        {
            return _view;
        }
    }
